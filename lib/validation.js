...
module.exports = function (opts) {
    ...
    var validationRules = {
        ...
        paymentUpdate: {
            /* We may just want to update the other fields (e.g. defaultPaymentMethod), without the need to provide all thos details. Actually, let Zuora return an error if any field is missing */
            // expirationMonth: validationObjects.expirationMonth,
            // expirationYear: validationObjects.expirationYear,
            // securityCode: validationObjects.securityCode,
            // cardHolderName: validationObjects.cardHolderName,
    ...
    return function (type, data) {
        /* 
         * Let Zuora return any error, if something is wrong, 
         * because using this client-side validation requires that we always keep in sync.
         * with changes in the Zuora APIs itself
        */
        return null;
